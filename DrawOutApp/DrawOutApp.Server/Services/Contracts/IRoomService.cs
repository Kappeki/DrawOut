...
namespace DrawOutApp.Server.Services.Contracts
{
    public interface IRoomService
    {
        ...
        Task<Result<Username,string>> AddPlayerAsync(string roomId, string sessionId, string? password = null);
        Task<Result<Username, string>> RemovePlayerAsync(string roomId, string sessionId);
